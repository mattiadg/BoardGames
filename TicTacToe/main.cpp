...
int main() {
	...
	std::cout << std::endl;
	std::cout << "The goal of the game is to get 3 of your symbols in a row. Be it horizontally, vertically or diagonally." << std::endl;
	std::cout << std::endl;

	// Instructions
	std::cout << "INSTRUCTIONS:" << std::endl;
	std::cout << std::endl;
	std::cout << "When prompted give 2 numbers between 0 and 2, which represent the row and column." << std::endl;
	std::cout << std::endl;
